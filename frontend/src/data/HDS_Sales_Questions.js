...
const hds_batch_1 = [
  // CHAPTER 1: The Hearth Design Specialist
  {
    id: "HDS-001",
    ...
    options: [
      ...
      "They are the only employees allowed to install gas lines.",
      "They manage the inventory and shipping exclusively.",
      "They perform all final safety inspections."
    ],
  ...
  },
  {
    ...
    options: [
      "A feature is the cost; a benefit is the discount.",
      "A feature is a product characteristic; a benefit is the reason the customer buys it.",
      "A feature is optional; a benefit is standard.",
  ...
  },
  {
    ...
    options: [
      "They make the customer feel interrogated.",
      "They do not incite discussion or encourage the customer to open up.",
      "They are considered rude in sales etiquette.",
      "They lengthen the sales process unnecessarily."
    ],
  ...
  },
  {
    ...
    options: [
      "Tell them their friend is wrong immediately.",
  ...
  },
  {
    ...
    options: [
      ...
      "They want a custom masonry build.",
      "They definitely want a gas log set."
    ],
  ...
  },
  {
    ...
    options: [
      "They are just browsing to kill time.",
      "They are looking for free advice.",
  ...
  // CHAPTER 3: Client Knowledge
  {
    ...
    options: [
      "Heating a small back room only.",
      "Having a fire for aesthetics on Christmas.",
      "Heating as much of the living area as possible for most of the cold weather.",
      "Providing heat only during power outages."
    ],
  ...
  },
  {
    ...
    options: [
      "The unit must be gas-fired.",
      "The unit must rely on 120V electricity.",
      "The unit must avoid reliance on utility company electricity.",
      "The unit must be EPA certified."
    ],
  ...
  },
  {
    ...
    options: [
      "A quick look at the chimney cap.",
      "A video scan of the interior flue required upon changes to the system.",
      "A destructive test of the masonry materials.",
      "A check of the roof flashing only."
    ],
  ...
  },
  {
    ...
    options: [
      "To determine the paint color.",
      "To calculate the resale value.",
      "To determine if makeup air is needed for combustion.",
      "To check for termites."
    ],
  ...
  },
  {
    ...
    options: [
      "Large units are too heavy to install.",
      "It can lead to overheating the room and inefficient low-burn operation.",
      "Large units always require 8-inch venting.",
      "Large units are ugly."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Performance is the only factor.",
      "Safety first, performance second, aesthetics third.",
      "Aesthetics first, safety second."
    ],
  ...
  // MIXED REVIEW: Application & Ethics
  {
    id: "HDS-025",
    ...
    options: [
      ...
      "Tell the client it isn't important."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "To charge them more later.",
      "To force them to buy elsewhere."
    ],
  ...
  // CHAPTER 4: Continued (Additional Questions)
  {
    id: "HDS-028",
    ...
    options: [
      ...
      "Through a window.",
      "Running horizontally along the siding."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Nothing, all fuel is the same.",
      "It cleans the chimney."
    ],
  ...
  },
  {
    ...
    options: [
      "It means the person owns the store.",
      ...
      "It allows the person to manufacture stoves."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "The time it takes to get a permit.",
      "The space inside the firebox."
    ],
...
const hds_batch_2 = [
  // CHAPTER 5: Communication
  {
    ...
    options: [
      "To ensure they are home for delivery.",
      "To discourage them from canceling the order.",
      "To maintain trust and keep them aware of the ETA of items and installation scheduling.",
      "To ask for a second deposit."
    ],
  ...
  },
  {
    ...
    options: [
      "The percentage of heat moved into the room.",
  ...
  },
  {
    ...
    options: [
      "It would make the room too hot.",
  ...
  },
  {
    ...
    options: [
      ...
      "They cannot have a thermostat.",
      "They must use a chimney."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "A safety test for gas valves.",
      "A standard for pellet quality."
    ],
  ...
  },
  {
    ...
    options: [
      "They must be lighter than 200 lbs.",
      "They must have outside combustion air and be secured to the floor.",
      "They cannot have glass doors.",
      "They must use single-wall pipe."
    ],
  ...
  },
  {
    ...
    options: [
      "Yes, all fireplaces are certified.",
      "No, but there is a voluntary 'Qualified' program for low-mass fireplaces.",
      "Yes, they must meet the same standards as woodstoves.",
      "No, fireplaces are illegal."
    ],
  ...
  },
  {
    ...
    options: [
      "A requirement to paint the house green.",
      "Additional efficiency or environmental standards (like LEED) above basic building codes.",
      "A code for greenhouses only.",
      "A discount program for woodstoves."
    ],
  ...
  // CHAPTER 9: Codes & Standards (Continued)
  {
    id: "HDS-067",
    question: "What does 'Clearance' mean in a hearth installation?",
    options: [
      "The sale price.",
      "The distance between the appliance and the nearest window.",
...
const hds_batch_3 = [
  // CHAPTER 10: Venting Systems
  {
    ...
    options: [
      ...
      "To look good on the exterior.",
      "To create a place for birds to nest."
    ],
  ...
  },
  {
    ...
    options: [
      "Draft increases because there is more room.",
  ...
  },
  {
    ...
    options: [
      "To test the durability of a door hinge.",
      "To measure the airtightness of a building.",
      "To see if the blower works.",
  ...
  },
  {
    ...
    options: [
      "3 feet wide, 2 feet deep, 10 feet tall.",
      "3 feet above the roof penetration, and 2 feet higher than anything within 10 feet horizontally.",
      "3 elbows max, 2 feet horizontal, 10 feet vertical.",
      "3 inches clearance, 2 inches overlap, 10 inches support."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "To structurally support the pipe.",
  ...
  },
  {
    ...
    options: [
      "A rule about recycling plastic.",
      "A regulation requiring certification for renovations disturbing paint in pre-1978 housing.",
      "A standard for lead-free gasoline.",
      "A rule for disposal of old stoves."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Just measure 18 inches from the wall.",
      "Use the diagonal of the room."
    ],
  ...
  // CHAPTER 12: Communication with Owners
  {
    ...
    options: [
      ...
      "Dump them in the garden while hot."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "It is illegal.",
      "It makes the vacuum smell good."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Firing the installer.",
      "Starting the fire from the top down.",
      "Using the wrong kind of match."
    ],
  ...
  },
  {
    ...
    options: [
      "A rule for firewood storage.",
      "The minimum height requirement for chimney termination above a roof.",
      "The size of the hearth pad.",
      "The distance to furniture."
    ],
...
const hds_batch_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      "To turn on the room fan.",
      "To measure the pellet size."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "The warranty period of the vent.",
  ...
  },
  {
    ...
    options: [
      "Corn ignites at a lower temperature.",
      "Corn ignites at a significantly higher temperature (500-700°F).",
      "Corn cannot be ignited electrically.",
      "There is no difference."
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "It increases home value the most.",
...
const hds_batch_5 = [
  // GAP: Installation Planning & Inspections (Ch 11 & 13)
  {
    id: "HDS-141",
  ...
  // GAP: Gas Systems & Outdoor Appliances (Ch 14)
  {
    id: "HDS-144",
    ...
    options: [
      ...
      "It must have a window.",
      "It cannot have a roof."
    ],
  ...
  },
  {
    ...
    options: [
      "Connecting two hoppers together.",
      "Pellets getting stuck across the feed opening, preventing fuel flow.",
      "A type of fuse.",
      "The connection between the auger and motor."
    ],
  ...
  },
  {
    ...
    options: [
      "A fan blows air into the burn pot.",
  ...
  },
  {
    ...
    options: [
      "One that burns oil and pellets.",
  ...
  // GAP: Coal & Electric Appliances (Ch 16)
  {
    id: "HDS-152",
  ...
  },
  {
    ...
    options: [
      ...
      "The temperature the stove must reach to burn.",
      "The freezing point of ash.",
  ...
  // GAP: Advanced Technical & Math (Appendices)
  {
    id: "HDS-155",
  ...
  },
  {
    ...
    options: [
      "Painting the inside of the chimney.",
  ...
  },
  {
    ...
    options: [
      ...
      "Venting is for gas; Ventilation is for wood.",
      "Venting is expensive."
    ],
